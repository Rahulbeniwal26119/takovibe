...
export const ShareButton: React.FC<ShareButtonProps> = ({ code, lang }) => {
    ...
    const generateIframeUrl = () => {
        ...
        return `<iframe src="${baseUrl}/embed/playground?${params.toString()}" width="100%" height="400" frameborder="0" sandbox="allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox"></iframe>`;
    };

    const handleCopy = () => {
        navigator.clipboard.writeText(generateIframeUrl());
        setCopied(true);
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        <div className="p-5">
                            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                                Copy the iframe snippet below to embed this interactive playground in your Medium, Dev.to, or personal blog.
                            </p>
                            <div className="relative">
                                <textarea 
                                    readOnly 
                                    value={generateIframeUrl()} 
                                    className="w-full h-24 p-3 font-mono text-xs text-gray-800 dark:text-gray-300 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500/50 resize-none selection:bg-purple-100 dark:selection:bg-purple-900/30"
                                />
                            </div>
